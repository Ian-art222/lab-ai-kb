...
.welcome-card {
  ...
  background: linear-gradient(135deg, #fff 0%, #f5f8fb 55%, #eef4fc 100%) !important;
  border: 1px solid var(--ds-line-subtle, #e0e3e7) !important;
}
.panel-card {
  border-radius: var(--ds-radius-lg, 16px);
}
...
.stat-value.success {
  color: var(--ds-success-text, #1b5e20);
}
.stat-value.warning {
