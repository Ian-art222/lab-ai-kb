...
class Settings(BaseSettings):
    ...
    qa_max_chunks_per_doc: int = 3
    qa_target_distinct_docs: int = 2
    qa_min_distinct_docs_for_multi_source: int = 2
    qa_single_doc_dominance_ratio: float = 1.2
    qa_merge_adjacent_gap: int = 1
    ...
    # Diversity-aware assembly
    qa_diversity_rerank_enabled: bool = True
    qa_diversity_lambda: float = 0.2
    qa_redundancy_sim_threshold: float = 0.88
